...
$twitch_clientKey = '1234123412341234123412341234123';
$twitch_clientSecret = '1234123412341234123412341234123';
$twitch_clientUrl = 'http://www.testurl.com';
...
{           
    ...
    private function generateOutput($function, $errStr, $outputLevel = 4)
    {
        ...
        {
            // Enter your output format code here
            writeLog(date('m-d-y||H:i:s => ') . $function . ' || ' . $errStr);
        }
    }
    ...
    public function getFollowers($chan, $limit, $offset, $sorting = 'desc')
    {
        ...
        $this->generateOutput($functionName, 'Getting the list of channels following channel: ' . $chan, 1);
